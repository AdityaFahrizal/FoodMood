...
class ResepComfortFoodPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepComfortFoodPage({super.key, required this.menuData});

  @override
  State<ResepComfortFoodPage> createState() => _ResepComfortFoodPageState();
}

class _ResepComfortFoodPageState extends State<ResepComfortFoodPage> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ComfortFoodPage()),
            );
          },
