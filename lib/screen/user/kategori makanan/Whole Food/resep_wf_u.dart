...
class ResepWholeFoodPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepWholeFoodPage({super.key, required this.menuData});

  @override
  State<ResepWholeFoodPage> createState() => _ResepWholeFoodPageState();
}

class _ResepWholeFoodPageState extends State<ResepWholeFoodPage> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => WholeFoodPage()),
            );
          },
