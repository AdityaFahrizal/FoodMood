...
class ResepSweetsFoodPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepSweetsFoodPage({super.key, required this.menuData});

  @override
  State<ResepSweetsFoodPage> createState() => _ResepSweetsFoodPageState();
}

class _ResepSweetsFoodPageState extends State<ResepSweetsFoodPage> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SweetsFoodPage()),
            );
          },
