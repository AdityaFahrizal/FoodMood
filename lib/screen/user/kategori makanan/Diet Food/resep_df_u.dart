...
class ResepDietFoodPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepDietFoodPage({super.key, required this.menuData});

  @override
  State<ResepDietFoodPage> createState() => _ResepDietFoodPageState();
}

class _ResepDietFoodPageState extends State<ResepDietFoodPage> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DietFoodPage()),
            );
          },
