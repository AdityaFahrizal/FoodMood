...
import 'package:food_mood_2/screen/admin/kategori%20makanan/junk%20food/resep_junkfood.dart';
...
class JunkFoodPageAdmin extends StatefulWidget {
  ...
  @override
  State<JunkFoodPageAdmin> createState() => _JunkFoodPageAdminState();
}

class _JunkFoodPageAdminState extends State<JunkFoodPageAdmin> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'JunkFood'),
            ),
          );
        },
