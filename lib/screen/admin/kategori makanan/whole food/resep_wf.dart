...
class ResepWholeFoodAdminPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepWholeFoodAdminPage({super.key, required this.menuData});

  @override
  State<ResepWholeFoodAdminPage> createState() => _ResepwholeFoodAdminPageState();
}

class _ResepwholeFoodAdminPageState extends State<ResepWholeFoodAdminPage> {
  @override
  Widget build(BuildContext context) {
    final menuData = widget.menuData;
    final String moodName =
        (menuData['mood'] ?? menuData['kategori'] ?? 'WholeFood').toString();
    final String menuId =
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => WholeFoodPageAdmin()),
            );
          },
