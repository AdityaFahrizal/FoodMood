...
class ResepSweetsFoodAdminPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepSweetsFoodAdminPage({super.key, required this.menuData});

  @override
  State<ResepSweetsFoodAdminPage> createState() => _ResepSweetsFoodAdminPageState();
}

class _ResepSweetsFoodAdminPageState extends State<ResepSweetsFoodAdminPage> {
  @override
  Widget build(BuildContext context) {
    final menuData = widget.menuData;
    final String moodName =
        (menuData['mood'] ?? menuData['kategori'] ?? 'SweetsFood').toString();
    final String menuId =
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SweetsFoodPageAdmin()),
            );
          },
