...
import 'package:food_mood_2/screen/admin/kategori%20makanan/sweets%20food/resep_sf.dart';
import 'package:food_mood_2/screen/admin/tambah_menu.dart';

class SweetsFoodPageAdmin extends StatefulWidget {
  const SweetsFoodPageAdmin({super.key});

  @override
  State<SweetsFoodPageAdmin> createState() => _SweetsFoodPageAdminState();
}

class _SweetsFoodPageAdminState extends State<SweetsFoodPageAdmin> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'SweetsFood'),
            ),
          );
        },
