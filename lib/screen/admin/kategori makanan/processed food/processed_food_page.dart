...
class ProcessedFoodPageAdmin extends StatefulWidget {
  const ProcessedFoodPageAdmin({super.key});

  @override
  State<ProcessedFoodPageAdmin> createState() => _ProcessedFoodPageAdminState();
}

class _ProcessedFoodPageAdminState extends State<ProcessedFoodPageAdmin> {
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('menuMood')
                  .where('mood', isEqualTo: 'ProcessedFood')
                  .snapshots(),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'ProcessedFood'),
            ),
          );
        },
