...
class ResepComfortFoodAdminPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepComfortFoodAdminPage({super.key, required this.menuData});

  @override
  State<ResepComfortFoodAdminPage> createState() => _ResepComfortFoodAdminPageState();
}

class _ResepComfortFoodAdminPageState extends State<ResepComfortFoodAdminPage> {
  @override
  Widget build(BuildContext context) {
    final menuData = widget.menuData;
    final String moodName =
        (menuData['mood'] ?? menuData['kategori'] ?? 'ComfortFood').toString();
    final String menuId =
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ComfortFoodPageAdmin()),
            );
          },
