...
import 'package:food_mood_2/screen/admin/kategori%20makanan/comfort%20food/resep.dart';
import 'package:food_mood_2/screen/admin/tambah_menu.dart';

class ComfortFoodPageAdmin extends StatefulWidget {
  const ComfortFoodPageAdmin({super.key});

  @override
  State<ComfortFoodPageAdmin> createState() => _ComfortFoodPageAdminState();
}

class _ComfortFoodPageAdminState extends State<ComfortFoodPageAdmin> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'ComfortFood'),
            ),
          );
        },
