...
import 'package:food_mood_2/screen/admin/kategori%20makanan/healty%20food/resep_hf.dart';
import 'package:food_mood_2/screen/admin/tambah_menu.dart';

class HealtyFoodPageAdmin extends StatefulWidget {
  const HealtyFoodPageAdmin({super.key});

  @override
  State<HealtyFoodPageAdmin> createState() => _HealtyFoodPageAdminState();
}

class _HealtyFoodPageAdminState extends State<HealtyFoodPageAdmin> {
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('menuMood')
                  .where('mood', isEqualTo: 'HealtyFood')
                  .snapshots(),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'HealtyFood'),
            ),
          );
        },
