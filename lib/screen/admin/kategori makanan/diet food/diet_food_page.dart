...
class DietFoodPageAdmin extends StatefulWidget {
  const DietFoodPageAdmin({super.key});

  @override
  State<DietFoodPageAdmin> createState() => _DietFoodPageAdminState();
}

class _DietFoodPageAdminState extends State<DietFoodPageAdmin> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'DietFood'),
            ),
          );
        },
