...
class ResepDietFoodAdminPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepDietFoodAdminPage({super.key, required this.menuData});

  @override
  State<ResepDietFoodAdminPage> createState() => _ResepDietFoodAdminPageState();
}

class _ResepDietFoodAdminPageState extends State<ResepDietFoodAdminPage> {
  @override
  Widget build(BuildContext context) {
    final menuData = widget.menuData;
    final String moodName =
        (menuData['mood'] ?? menuData['kategori'] ?? 'DietFood').toString();
    final String menuId =
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DietFoodPageAdmin()),
            );
          },
