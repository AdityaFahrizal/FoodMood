...
import 'package:food_mood_2/screen/admin/kategori%20makanan/pasty%20food/resep_pf.dart';
import 'package:food_mood_2/screen/admin/tambah_menu.dart';

class PastryFoodPageAdmin extends StatefulWidget {
  const PastryFoodPageAdmin({super.key});

  @override
  State<PastryFoodPageAdmin> createState() => _PastryFoodPageAdminState();
}

class _PastryFoodPageAdminState extends State<PastryFoodPageAdmin> {
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('menuMood')
                  .where('mood', isEqualTo: 'PastryFood')
                  .snapshots(),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahMenuMoodPage(mood: 'PastryFood'),
            ),
          );
        },
