...
class ResepBosanAdminPage extends StatefulWidget {
  final Map<String, dynamic> menuData;
  const ResepBosanAdminPage({super.key, required this.menuData});

  @override
  State<ResepBosanAdminPage> createState() => _ResepBosanAdminPageState();
}

class _ResepBosanAdminPageState extends State<ResepBosanAdminPage> {
  @override
  Widget build(BuildContext context) {
    final menuData = widget.menuData;
    final String moodName =
        (menuData['mood'] ?? menuData['kategori'] ?? 'Bosan').toString();
    final String menuId =
