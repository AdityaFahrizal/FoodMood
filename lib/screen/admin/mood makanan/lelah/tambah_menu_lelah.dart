...
class TambahMenuLelah extends StatefulWidget {
  @override
  _TambahMenuLelah createState() => _TambahMenuLelah();
}

class _TambahMenuLelah extends State<TambahMenuLelah> {
  ...
  Future<void> saveMenuItem() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('menuLelah').add({
        'name': menuName,
