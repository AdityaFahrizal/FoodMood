...
class TambahMenuSedih extends StatefulWidget {
  @override
  _TambahMenuSedih createState() => _TambahMenuSedih();
}

class _TambahMenuSedih extends State<TambahMenuSedih> {
  ...
  Future<void> saveMenuItem() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('menuSedih').add({
        'name': menuName,
