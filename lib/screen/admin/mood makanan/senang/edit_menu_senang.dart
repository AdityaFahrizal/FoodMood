...
class EditMenuSenang extends StatefulWidget {
  final String docId;
  final Map<String, dynamic> data;

  const EditMenuSenang({super.key, required this.docId, required this.data});

  @override
  State<EditMenuSenang> createState() => _EditMenuSenangState();
}

class _EditMenuSenangState extends State<EditMenuSenang> {
